...
import it.uniba.dib.sms222329.fragment.tesiscelta.TesiSceltaFragment;
...
public class ListaTesiScelteAdapter extends BaseAdapter {
     ...
     * @param manager
     */
    public ListaTesiScelteAdapter(Context context, List<TesiScelta> tesiScelte, FragmentManager manager) {
     ...
     * @param richiesta
     */
    public ListaTesiScelteAdapter(Context context, List<TesiScelta> tesiScelte, FragmentManager manager, boolean richiesta) {
        this.tesiScelte = tesiScelte;
        this.inflater = LayoutInflater.from(context);
        this.manager = manager;
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        dettagli.setOnClickListener(view -> {
            if(Utility.accountLoggato == Utility.RELATORE){
                Utility.replaceFragment(manager, R.id.container, new TesiSceltaFragment(tesiScelte.get(i)));
            } else {
                Utility.replaceFragment(manager, R.id.container, new TesiSceltaFragment(tesiScelte.get(i), richiesta));
            }
