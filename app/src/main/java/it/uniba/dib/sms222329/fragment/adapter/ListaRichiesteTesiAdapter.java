...
import it.uniba.dib.sms222329.fragment.richiestatesi.RichiestaTesiRispostaFragment;
import it.uniba.dib.sms222329.fragment.richiestatesi.RichiestaTesiDettagliFragment;

public class ListaRichiesteTesiAdapter extends BaseAdapter {
    ...
    public ListaRichiesteTesiAdapter(Context context, List<RichiestaTesi> richieste, FragmentManager manager) {
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if(Utility.accountLoggato == Utility.RELATORE){
            ...
            dettagli.setOnClickListener(view -> {
                Utility.replaceFragment(manager, R.id.container, new RichiestaTesiDettagliFragment(richieste.get(i)));
            });
        }
